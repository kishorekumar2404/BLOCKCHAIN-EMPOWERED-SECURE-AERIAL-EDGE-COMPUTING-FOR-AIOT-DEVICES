            ...
            <div id="page-inner">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        ...
                        <center>   <form action="upload.jsp" method="post" enctype="multipart/form-data" id="form2">
                                <center><p style="font-size: 20px;"><b>VIEW FILES</b></p></center>
                <p align="center">
				<%
            
        int i=0;
       String qry1="select * from upload";
       ResultSet rs=stmt.executeQuery(qry1);
       out.println("<table border=1 align=center width='100%' >");
     out.println("<tr style='height:40px;'><th>Serial Number</th><th>File</th><th>FileType</th></tr>");
       while(rs.next())
            {
